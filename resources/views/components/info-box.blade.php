...
<div class="{{ $color }} text-white rounded-lg shadow-lg p-6 transform hover:scale-105 transition-all duration-200 hover:shadow-xl">
    ...
    <!-- Optional pulse animation for dynamic feel -->
    <div class="absolute inset-0 bg-white opacity-0 hover:opacity-10 rounded-lg transition-opacity duration-200"></div>
</div>
